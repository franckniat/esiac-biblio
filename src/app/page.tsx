      ...
      <main className="max-w-[1340px] mx-auto px-2 ">
        ...
        style={{
          ...
          <section className='flex justify-center'>
              <Link href="/support" className="group dark:text-white dark:bg-neutral-800 dark:hover:bg-neutral-700 inline-flex active:scale-95 transition items-center hover:bg-gray-200 p-1 pr-2 text-black bg-gray-100 border-red-600 rounded-full sm:text-base lg:text-sm xl:text-base">
                  <div className="px-3 py-0.5 text-black dark:text-white text-xs font-semibold leading-5 uppercase tracking-wide rounded-full bg-gray-300 dark:bg-neutral-900">
                    ⚡️Sponsor
                  </div>
